...
export const dailyShortcutCards: AACCard[] = [
  ...
  { id: 'sh3', burmese: 'ဗိုက်ဆာတယ်', englishMeaning: 'I am hungry', category: 'shortcut', emoji: '' },
...
export const verbCards: AACCard[] = [
  // 🔵 Verbs (ကြိယာများ)
  { id: 'v1', burmese: 'စားမယ်', englishMeaning: 'eat', category: 'verb', subCategory: 'verb', emoji: '' },
  ...
  { id: 'm3', burmese: 'ခံစားရတယ်', englishMeaning: 'feel', category: 'verb', subCategory: 'modal', emoji: '' },
...
export const objectCards: AACCard[] = [
  ...
  { id: 'o7', burmese: 'အနားယူချိန်', englishMeaning: 'break time', category: 'object', emoji: '' },
...
export const bodyPartCards: AACCard[] = [
  { id: 'bp1', burmese: 'ခေါင်း', englishMeaning: 'head', category: 'body_part', emoji: '' },
...
export const numberCards: AACCard[] = [
  ...
  { id: 'num1', burmese: '၁', englishMeaning: '1', category: 'number', emoji: '' },
  { id: 'num2', burmese: '၂', englishMeaning: '2', category: 'number', emoji: '' },
  { id: 'num3', burmese: '၃', englishMeaning: '3', category: 'number', emoji: '' },
  { id: 'num4', burmese: '၄', englishMeaning: '4', category: 'number', emoji: '' },
  { id: 'num5', burmese: '၅', englishMeaning: '5', category: 'number', emoji: '' },
  { id: 'num6', burmese: '၆', englishMeaning: '6', category: 'number', emoji: '' },
  { id: 'num7', burmese: '၇', englishMeaning: '7', category: 'number', emoji: '' },
  { id: 'num8', burmese: '၈', englishMeaning: '8', category: 'number', emoji: '' },
  { id: 'num9', burmese: '၉', englishMeaning: '9', category: 'number', emoji: '' },
  { id: 'num10', burmese: '၁၀', englishMeaning: '10', category: 'number', emoji: '' },
];

// Directions & Positions
export const directionCards: AACCard[] = [
  { id: 'dir1', burmese: 'ရှေ့', englishMeaning: 'front', category: 'direction', emoji: '' },
  { id: 'dir2', burmese: 'နောက်', englishMeaning: 'back / behind', category: 'direction', emoji: '' },
  ...
  { id: 'dir5', burmese: 'ဘယ်', englishMeaning: 'left', category: 'direction', emoji: '' },
  { id: 'dir6', burmese: 'ညာ', englishMeaning: 'right', category: 'direction', emoji: '' },
...
export const locationCards: AACCard[] = [
  ...
  { id: 'loc6', burmese: 'ကုတင်', englishMeaning: 'bed', category: 'location', emoji: '' },
